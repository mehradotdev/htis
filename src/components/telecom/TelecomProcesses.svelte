        ...
        >
          ...
          <div
            class="absolute bg-base-300 pointer-events-none rounded-full
                   ...
                   lg:left-[1.125rem] lg:top-[22px] lg:bottom-[22px] lg:right-auto lg:w-[2px] lg:h-auto"
          >
        ...
        {#key activeIndex}
          <div in:fade={{ duration: 350 }}>
            ...
            <div class="flex flex-col md:flex-row gap-6 lg:gap-8">
              ...
              <!-- Image -->
              <div
                class="w-full md:w-[42%] shrink-0 rounded-2xl overflow-hidden aspect-[3/4] bg-base-300/30"
              >
                {#key activeIndex}
                  <img
