...
sections:
  ...
  - id: challenge
    ...
    heroImageAlt: Airport security monitoring and surveillance infrastructure
    accentColor: yellow
  ...
  - id: solution-details
    ...
    heroImageAlt: Integrated security control room and smart space systems
    accentColor: green
  ...
  - id: outcomes
    ...
    content:
      ...
      items:
        - title: 1,000+
          text: High-definition AI cameras
        - title: 40%
          text: Reduction in staff gate queue times
        - title: 100%
          text: Coverage of airfield perimeter zones
  - id: why-htis
    layout: no-image
    accentColor: green
