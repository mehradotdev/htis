...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    whatYouWillDo:
      'As a Backend Engineer, you will be responsible for designing, building, and maintaining the core services that power our applications. You will work on building scalable APIs, optimizing database queries, and ensuring the reliability and performance of our infrastructure.',
    responsibilities: [
  ...
  },
  {
    ...
    whatYouWillDo:
      'As a Product Manager, you will lead the ideation, development, and launch of innovative products. You will work closely with cross-functional teams including engineering, design, and marketing to execute the product vision and deliver value to our users.',
    responsibilities: [
  ...
  },
  {
    ...
    experience: '2+ Year of Experience',
    whatYouWillDo:
      'As a UX Designer, you will be responsible for delivering the best online user experience. You will be designing ideas using various methods and latest technology. You will be designing graphic user interface elements, like menus, tabs, and widgets.',
    responsibilities: [
...
/**
 * Resolves a presentable job detail model from the Hiring API record by merging
 * live fields with the closest local content template and sensible fallbacks.
 */
export function resolveJobDetails(apiJob: HiringApiJob): Job {
  ...
  return {
    ...
    experience:
      apiJob.minExperience && apiJob.maxExperience
        ? `${apiJob.minExperience}-${apiJob.maxExperience} Years of Experience`
        : match.experience,
    whatYouWillDo:
      apiJob.description && apiJob.description.length > 10
        ? apiJob.description
        : match.whatYouWillDo,
